...
import com.example.allmighty.calculator.presentation.round.EditRoundViewModel
...
@Composable
fun EditRoundScreenRoot(
    modifier: Modifier = Modifier,
    navController: NavController,
    viewModel: EditRoundViewModel = hiltViewModel()
) {
    EditRoundScreen(
        modifier = modifier,
        navController = navController,
...
@PreviewLightDark
@Composable
private fun EditRoundScreenPreview() {
    AllMightyTheme {
        EditRoundScreen(
